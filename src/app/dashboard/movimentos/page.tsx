    ...
    <div className="casha-wrap">
      <div className="casha-shell">
        ...
        <div className="workspace-shell">
          <DashboardSidebar current="movements" selectedMonth={selectedMonth} lang={lang} currency={currency} showBottomControls userDisplayName={name} logoutLabel={lang === "pt-PT" ? "Terminar sessão" : "Logout"} />
